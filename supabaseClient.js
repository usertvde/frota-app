...
const EDGE_FUNCTION_URL = "https://oaztprykumrbubqxjkmb.supabase.co/functions/v1/manage-users"; // Substitui pelo teu URL real

// Criar o cliente Supabase (torna-o global para outros scripts)
